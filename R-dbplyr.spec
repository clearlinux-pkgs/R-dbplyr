...
Version  : 1.2.2
Release  : 13
URL      : https://cran.r-project.org/src/contrib/dbplyr_1.2.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/dbplyr_1.2.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532571916
