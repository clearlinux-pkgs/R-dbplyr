...
Source0  : https://cran.r-project.org/src/contrib/dbplyr_2.0.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604519545
...
/usr/lib64/R/library/dbplyr/tests/testthat/test-backend-postgresql-old.R
